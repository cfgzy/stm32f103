...
//	LCD_LED=1;		//点亮背光
	GPIO_SetBits(GPIOB, GPIO_Pin_0);  // 强制拉高
	LCD_Clear(WHITE);
...
void Font_Test(void)
{
	...
	Draw_Font16B(16,144,BLUE,"abcdefghijklmnopqrstuvwxyz");
	Draw_Font16B(16,160,BLUE,"ABCDEFGHIJKLMNOPQRSTUVWXYZ");
...
void Demo_Menu(void)
{
	...
	Draw_Font16B(16,180,RED,"abcdefghijklmnopqrstuvwxyz");
	Draw_Font16B(16,196,RED,"ABCDEFGHIJKLMNOPQRSTUVWXYZ");
